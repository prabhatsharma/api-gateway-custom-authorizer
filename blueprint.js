...
var validateGoogleToken = require("./lib/google");
...
exports.handler = (event, context, callback) => {
    //console.error('Client token:', event.authorizationToken);
    ...
    validateGoogleToken(event.authorizationToken, function (error, result) {
        console.log("\nValidation complete. event was: ", event);
        if (!error) {
            ...
            const principalId = result.email; 
